...
const CourseSection = () => {
    ...
    if(isLoading){
      ...
      return (
        <section className="py-8 my-10 mt-14 ">
          <div className="2xl:max-w-[1500px] lg:w-[80%] mx-auto px-6 text-">
            <h2 className="text-5xl font-serif mx-auto text-center font-bold text-gray-800 mb-4">Explore Our<span className='bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent'> Courses</span></h2>
            <p className="text-gray-600 text-center mb-14 mx-auto md:w-[60%] ">Choose from a variety of high-quality courses to enhance your skills.Choose from a variety of high-quality courses to enhance your skills.</p>
